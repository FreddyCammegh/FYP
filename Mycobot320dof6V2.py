...
E11 = rtb.ET.tx(-0.655)
E12 = rtb.ET.Rx()
mc =  E1  * E2 * E3 * E4 * E5 * E6 * E7 * E8 * E9 * E10 * E11 * E12 
# View the ETS
...
class Mycobot(ERobot):
    ...
    def __init__(self):
        super().__init__(
                [L1, L2, L3, L4, L5, L6], name="Mycobot")
        
        self.addconfiguration_attr("qz", np.array([0,0,0,0,0,0]))
        #self.qr = np.array([-0.01064651, -0.38030724,  2.2226768,  -0.3572689,  -0.0137881,  -0.01675516])
        self.qr = np.array([-0.01064651, -0.38030724,  2.2226768,  -0.3572689,  0,  0])
        self.qf = np.array([0.224,0.371,-0.055,-0.89,-0.086,-0.046])
        self.qf2 = np.array([-pi*0.8, -0.38030724,  2.2226768,  -0.3572689,  -0.0137881,  -0.01675516])
        self.qz = np.array([0,0,0.05,0,0,0])
